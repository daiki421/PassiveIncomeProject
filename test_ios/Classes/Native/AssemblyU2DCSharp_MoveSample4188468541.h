...
{
public:
	// UnityEngine.GameObject MoveSample::gameObject
	GameObject_t1756533147 * ___gameObject_2;

public:
	inline static int32_t get_offset_of_gameObject_2() { return static_cast<int32_t>(offsetof(MoveSample_t4188468541, ___gameObject_2)); }
